...
namespace UI
{
	...
	///
	/// 
	/// Shamelessly "borrowed" from "FEEL".
	/// </summary>
	[MMRequiresConstantRepaint]
	//[AddComponentMenu("More Mountains/Tools/GUI/MMProgressBar")]
	public class ProgressBar : MMMonoBehaviour
	{
		...
		[MMInspectorGroup("Foreground SegmentedBar Settings", true, 12)]
		...
		[MMInspectorGroup("Delayed SegmentedBar Decreasing", true, 13)]
		...
		[MMInspectorGroup("Delayed SegmentedBar Increasing", true, 18)]
